...
export class DirectorComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    if (this.currentSearch) {
      this.directorService
        ...
        .subscribe(
          (res: HttpResponse<IDirector[]>) => this.paginateDirectors(res.body, res.headers),
  ...
  trackId(index: number, item: IDirector) {
    return item.id;
  }
  ...
  protected paginateDirectors(data: IDirector[], headers: HttpHeaders) {
