...
import es.curso.myproject.config.audit.AuditEventConverter;
import es.curso.myproject.domain.PersistentAuditEvent;
...
import static es.curso.myproject.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
