...
import es.curso.myproject.config.Constants;
import es.curso.myproject.domain.Authority;
import es.curso.myproject.domain.User;
import es.curso.myproject.repository.AuthorityRepository;
import es.curso.myproject.repository.UserRepository;
import es.curso.myproject.security.AuthoritiesConstants;
import es.curso.myproject.service.MailService;
import es.curso.myproject.service.UserService;
import es.curso.myproject.service.dto.PasswordChangeDTO;
import es.curso.myproject.service.dto.UserDTO;
import es.curso.myproject.web.rest.errors.ExceptionTranslator;
import es.curso.myproject.web.rest.vm.KeyAndPasswordVM;
import es.curso.myproject.web.rest.vm.ManagedUserVM;
